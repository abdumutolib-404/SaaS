...
export const freeAPIsService = {
     ...
     */
    async tryHuggingFaceAPI(prompt) {
        try {
     ...
     */
    async tryPollinationsAPI(prompt) {
        try {
     ...
     */
    async tryStableDiffusionAPI(prompt) {
        try {
            const response = await axios.post('https://api-inference.huggingface.co/models/stabilityai/stable-diffusion-2-1', {
                inputs: prompt
            }, {
                headers: {
                    'Authorization': `Bearer ${process.env.HUGGINGFACE_API_KEY || 'hf_demo_key'}`,
     ...
     */
    async tryHuggingFaceImageAPI(prompt) {
        try {
     ...
     */
    async tryMicrosoftTTSAPI(text) {
        try {
            // This would use Microsoft Cognitive Services TTS free tier
            const response = await axios.post('https://eastus.tts.speech.microsoft.com/cognitiveservices/v1', `<speak version='1.0' xml:lang='en-US'>
...
//# sourceMappingURL=free_apis.js.map