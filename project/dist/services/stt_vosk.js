...
export const voskSTTService = {
     ...
     */
    async convertSpeechToText(audioBuffer, userId, language = 'en') {
        try {
            // Check usage limit
     ...
     */
    async convertWithVosk(audioBuffer, language = 'en') {
...
try:
     ...
     */
    async convertWithSimpleSTT(audioBuffer) {
        return new Promise((resolve) => {
            try {
     ...
     */
    async convertWithFallback(audioBuffer) {
        try {
...
//# sourceMappingURL=stt_vosk.js.map