...
export const smartFeaturesService = {
     ...
     */
    async getSmartSuggestions(userId, currentMessage) {
        try {
            const suggestions = [];
     ...
     */
    async getTopicSuggestions(userId, currentMessage) {
        try {
     ...
     */
    async learnFromInteraction(userId, userMessage, botResponse) {
        try {
     ...
     */
    async updateUserPreference(userId, preferenceType, preferenceValue, confidenceIncrement) {
        try {
...
//# sourceMappingURL=smart_features.js.map