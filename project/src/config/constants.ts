...
export const DEFAULT_DAILY_TOKENS = parseInt(process.env.DEFAULT_DAILY_TOKENS || '1000');
export const DEFAULT_TOTAL_TOKENS = parseInt(process.env.DEFAULT_TOTAL_TOKENS || '10000');
